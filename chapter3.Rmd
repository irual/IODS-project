# Introduction to Open Data Science 2020, Week 3
## Logistic regression analysis excercise
...
Data: [https://archive.ics.uci.edu/ml/datasets/Student+Performance] (https://archive.ics.uci.edu/ml/datasets/Student+Performance).
...
### 7. 10-fold cross-validation ("bonus task")
...
### 8. 10-fold cross-validation comparison ("super-bonus task")
